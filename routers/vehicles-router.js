...
router.get('/', (req, res) => getVehiclesController(req, res, null));
router.get('/:id', (req, res) => getVehiclesController(req, res, null))
router.get('/types/:id', (req, res) => getVehiclesController(req, res, 'types'));

router.post('/', postVehiclesController);
router.put('/:id', putVehiclesController);
router.delete('/:id', deleteVehiclesController);
